...
class Encoder(nn.Module):
    def __init__(self, num_classes):
        ...
        for i in range(0, 3):
           self.layers.append(EDDSBlock(64, 0.3, 1)) 

        self.layers.append(DownsamplerBlock(64,128))

        self.layers.append(EDDSBlock(128, 0.3, 1))
        self.layers.append(EDDSBlock(128, 0.3, 2))
        self.layers.append(EDDSBlock(128, 0.3, 4))
        self.layers.append(EDDSBlock(128, 0.3, 8))
        self.layers.append(EDDSBlock(128, 0.3, 16))
